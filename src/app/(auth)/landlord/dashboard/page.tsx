...
export default async function LandlordDashboardPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <h1 className="text-3xl font-bold text-center text-gray-800">Landlord Dashboard</h1>

      <div className="mt-6 bg-white p-6 rounded-xl shadow flex flex-col items-center">
        <Avatar className="w-24 h-24 mb-4">
          <AvatarImage src={avatarUrl} alt="User avatar" />
          <AvatarFallback>
            {user.user_metadata?.full_name ? getInitials(user.user_metadata.full_name) : 'LD'}
          </AvatarFallback>
        </Avatar>
